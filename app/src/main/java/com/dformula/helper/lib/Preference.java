package com.dformula.helper.lib;
...
/*    MODE_PRIVATE
    ...
    private static com.dformula.helper.lib.Preference mInatance = null;
    ...
    public static com.dformula.helper.lib.Preference get(Context context, String name)
    {
        synchronized (com.dformula.helper.lib.Preference.class )
        {
            if( mInatance == null )
                mInatance = new com.dformula.helper.lib.Preference(context, name);
        }

        return mInatance;
    }

    public static com.dformula.helper.lib.Preference get(Context context)
    {
        synchronized (com.dformula.helper.lib.Preference.class )
        {
            if( mInatance == null )
                mInatance = new com.dformula.helper.lib.Preference(context);
        }
